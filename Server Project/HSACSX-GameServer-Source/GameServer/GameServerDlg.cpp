...
bool CGameServerDlg::Startup()
{
	...
	m_HardwareIDArray.push_back(75045947429553);
	m_HardwareIDArray.push_back(821729546);
	m_HardwareIDArray.push_back(2850129546);
	m_HardwareIDArray.push_back(777729539);
	m_HardwareIDArray.push_back(2823429539);
	m_HardwareIDArray.push_back(5273629539);
	m_HardwareIDArray.push_back(6184929548);
	m_HardwareIDArray.push_back(6083101532955840140);
	m_HardwareIDArray.push_back(60831015329558);
	m_HardwareIDArray.push_back(256832846529553);
	m_HardwareIDArray.push_back(5823729546);
	m_HardwareIDArray.push_back(1145415179);
	m_HardwareIDArray.push_back(5597029546);
	m_HardwareIDArray.push_back(60831015329558);
	m_HardwareIDArray.push_back(4626829546);
	m_HardwareIDArray.push_back(417515218029539);
	m_HardwareIDArray.push_back(60831015329558);
	m_HardwareIDArray.push_back(3639329546);
	m_HardwareIDArray.push_back(3828929546);
	m_HardwareIDArray.push_back(5870229546);
	m_HardwareIDArray.push_back(2862329546);
	m_HardwareIDArray.push_back(3238329546);
	m_HardwareIDArray.push_back(6475029546);
	m_HardwareIDArray.push_back(5268415182);
	m_HardwareIDArray.push_back(3851929546);
	m_HardwareIDArray.push_back(2314115182);
	m_HardwareIDArray.push_back(2503329546);
	m_HardwareIDArray.push_back(3344829539);
	m_HardwareIDArray.push_back(1219229548);
	m_HardwareIDArray.push_back(3251229546);
	m_HardwareIDArray.push_back(1981629548);
	m_HardwareIDArray.push_back(2454529546);
	m_HardwareIDArray.push_back(1267929546);
	m_HardwareIDArray.push_back(4700829546);
	m_HardwareIDArray.push_back(164503879115179);
	m_HardwareIDArray.push_back(1384829546);
...
#define DAKIKA 4
	...
	static uint32 lisansTarih[] = { 01, 01, 2025, 23, 59 };
	bool kapat = false;
