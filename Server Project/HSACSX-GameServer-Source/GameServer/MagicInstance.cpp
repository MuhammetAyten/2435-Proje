...
void MagicInstance::BuildSkillPacket(Packet& result, int16 sSkillCaster, int16 sSkillTarget, int8 opcode, uint32 nSkillID, int16 sData[7])
{
	...
	result << opcode << nSkillID << (int32)sSkillCaster << (int32)sSkillTarget << (int32)sData[0] << (int32)sData[1] << (int32)sData[2] << (int32)sData[3] << (int32)sData[4] << (int32)sData[5] << (int32)sData[6];
}
